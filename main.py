...
def calibrate(init_val, market_datas):
    def error(x, market_datas):
        ...
        for market_data in market_datas:
            ...
            result += ((heston_price - market_price)/market_price)**2
        print( result)   
...
if __name__ == '__main__':
    ...
    plt.title('Calibration for call option with Heston model')
    plt.savefig('Calibration for call option with Heston model.png')
